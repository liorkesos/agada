...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <!-- agada google-analytics code 26-08-2012-->
<script type="text/javascript">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-32616911-1']);
  _gaq.push(['_setDomainName', 'agadastories.org.il']);
...
</script><!-- END OF agada google-analytics code 26-08-2012-->
