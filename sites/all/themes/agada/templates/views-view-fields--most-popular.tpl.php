 ...
 *
 * Channa Added:
 * $field_gada_categories: agada categories of node.
 * $field_agada_tags: free tags of node.
 */
?>

<?php if (preg_match('/\D1\D/', $fields['counter']->content)) :?><h2 class="page-visitors-page-right-title blue">הסיפורים המדוברים</h2>
<?php endif; ?>
  ...
  <div class="content">              
	<div class="taxonomy-term-right">
		<?php  
			...
			else {print "<a href='$category_image'><img src='$category_image' alt='' title='' /></a>";}
		?>
	</div>
	
	<div class="taxonomy-term-left">    
		<h2><?php print $fields['title']->content; ?></h2>
		<div id="left-taxonomy"><p><?php print short_text($fields['body']->content, 400); ?></p></div>
