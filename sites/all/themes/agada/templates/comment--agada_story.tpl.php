...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php $comment_type_value = render($content['field_comment_type']); ?>  
  <div class="comment_type  <?php  print $types_colors_arr[$comment_type_value]; ?>"><?php print $comment_type_value; ?></div>
  ...
  <div class="open_close_comment">
  	<div class="more_comment">עוד <img src="../sites/all/themes/agada/images/more.png"></div>
    <div class="close_comment">סגירה <img src="../sites/all/themes/agada/images/x.png"></div>
  </div>
