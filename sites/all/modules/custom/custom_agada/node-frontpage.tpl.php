...
?>
            	...
            	<div class="js-small-content">	               
					<?php if (isset($content['group_agada_content']['field_agada_image']) &&  isset($node->frontpage_display_style) &&  $node->frontpage_display_style == EXTENDED_VERSION) : ?> 
							<?php
						//print $simple_field_agada_image;
					         print render(token_replace('[node:field_agada_image]', array('node' => $node)));
							 	//print render($content['group_agada_content']['field_agada_image']);
							?>
					<?php elseif (isset($content['group_agada_content']['field_agada_foursquare_image']) &&  isset($node->frontpage_display_style) &&  $node->frontpage_display_style > EXTENDED_VERSION) : ?>
							<?php
                ...
                <div class="js-overlay-caption-content">
                    ...
                    <p><?php 
			              ...
			              $rendered_content = preg_replace('/\"/',' &quot;',$rendered_content); 
							  print short_text($rendered_content, 400);
							  ?>...
							</p>
                    ...
                    <div class="story_details">
                        <img src="../sites/all/themes/agada/images/comment_icon.png" alt="מספר תגובות " title="מספר תגובות " />
                        <span class="comment_counter"><?php print $comment_count; ?></span>
								<?php  if (isset($content['group_agada_content']['field_children_version'])) : ?>
									<img src="/sites/all/themes/agada/images/figure_icon.png" alt="קיים עיבוד לילדים" title="קיים עיבוד לילדים"/>
								<?php endif; ?>
                       <?php if (isset($node->frontpage_display_style) && $node->frontpage_display_style >= EXTENDED_VERSION) : ?>
                    ...
                    <a href="<?php print $node_url; ?>" class="story_entrance">כניסה</a>    
